...
export function ListSupportedEncodings():Promise<Array<textcodec.EncodingMeta>>;
...
export function SaveTextFileAsWithEncoding(arg1:string,arg2:string,arg3:string,arg4:boolean):Promise<main.SaveFileResult>;
